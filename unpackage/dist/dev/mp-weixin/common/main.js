...
var _links = _interopRequireDefault(__webpack_require__(/*! static/utils/links.js */ 9));
var _request = _interopRequireDefault(__webpack_require__(/*! static/utils/request.js */ 10));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
    ...
    if (token) {
      ...
      uni.login({
        success: function success(wes) {
          provider: 'weixin',
          _vue.default.prototype.Get(_vue.default.prototype.Url.wechatLogin, { code: wes.code }).then(function (res) {
            if (res.code === 1e4) {
