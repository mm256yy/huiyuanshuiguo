	...
	<view class="content">
		<block v-if="brandInfo">
			<view class="headerBox" :style="'background-color:'+brandInfo.mini_color">
				...
				<view class="text" :style="'color:'+brandInfo.mini_color" v-if="brandInfo.mini_intro"><text></text><span>{{brandInfo.mini_intro}}</span></view>
			</view>
			<view class="infoBox">
			...
			<view class="button_box" :style="'background-color:'+brandInfo.mini_color" @click="getMiniTap()">免费定制小程序</view>
		</block>
